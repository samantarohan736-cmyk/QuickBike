  ...
  return (
    <main className="min-h-screen bg-slate-100 px-3 py-4 sm:px-6 lg:px-10">
      <div
        ...
        className="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-md flex-col overflow-hidden rounded-[2rem] bg-cyan-50 shadow-2xl ring-1 ring-black/10 lg:min-h-[780px] lg:max-w-7xl"
      >
        ...
        <section className="grid flex-1 lg:grid-cols-[minmax(0,1fr)_390px]">
          <div className="relative min-h-[540px] overflow-hidden bg-cyan-200 sm:min-h-[620px] lg:min-h-0">
            ...
            <div className="absolute inset-0 opacity-70 [background-image:linear-gradient(30deg,transparent_0_34%,rgba(255,255,255,.75)_35%_38%,transparent_39%_100%),linear-gradient(145deg,transparent_0_44%,rgba(255,255,255,.75)_45%_48%,transparent_49%_100%)]" />

            <div className="absolute left-1/2 top-5 z-10 flex w-[86%] -translate-x-1/2 items-center justify-between rounded-3xl bg-white/95 px-5 py-4 shadow-xl lg:left-8 lg:top-8 lg:w-[360px] lg:translate-x-0">
              <div>
            ...
            <div className="absolute left-[67%] top-[27%] h-[28%] w-[24%] rounded-br-[4rem] rounded-tr-[4rem] border-r-[10px] border-t-[10px] border-orange-400 lg:left-[68%] lg:top-[30%] lg:h-[34%] lg:w-[20%] lg:border-r-[14px] lg:border-t-[14px]" />
            <div className="absolute left-[38%] top-[32%] h-[34%] border-l-[6px] border-dashed border-orange-500 lg:left-[44%] lg:top-[36%] lg:h-[42%] lg:border-l-[8px]" />
            ...
            <div className="absolute bottom-0 left-0 right-0 z-20 rounded-t-[2rem] bg-white px-6 pb-5 pt-6 shadow-2xl lg:hidden">
              <RideDetails onSafetyClick={() => navigate("/tracking")} />
            </div>
          </div>
          ...
          <aside className="hidden bg-white p-6 shadow-2xl lg:flex lg:flex-col lg:justify-between">
            ...
            <nav className="mt-6 grid grid-cols-3 rounded-3xl bg-cyan-50 p-3">
              <NavItem active icon={Bike} label="Ride" />
...
function RideDetails({ onSafetyClick }) {
  return (
    <>
      <div className="flex items-center gap-4">
        <div className="relative flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-cyan-700 to-orange-400 text-2xl font-extrabold text-white">
          BS
      ...
      <button
        ...
        className="mt-5 flex w-full items-center justify-center gap-3 rounded-full bg-gradient-to-r from-orange-700 to-orange-500 px-5 py-4 text-base font-extrabold text-gray-950 shadow-xl shadow-orange-500/20 transition hover:from-orange-800 hover:to-orange-500"
      >
        <ShieldAlert size={20} />
        Safety Center & SOS
      </button>
